...
#OPENCV_CFLAGS = -I/opt/opencv3/include
#OPENCV_LIBS   = -L/opt/opencv3/lib -lopencv_core


COMPILEFLAGS = -g -I MY_CUSTOM_INCLUDE_PATH -D_LINUX -D_REENTRANT -Wall  -O3 -march=nocona -msse3 $(OPENCV_CFLAGS)
LINKFLAGS = -L MY_CUSTOM_LINK_PATH -lGVars3 -lcvd $(OPENCV_LIBS) -llapack -lGL

# Edit this line to change video source
#VIDEOSOURCE = VideoSource_Linux_file.o
